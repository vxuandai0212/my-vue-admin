<template>
  <div class="flex">
    <div
      class="basis-1/4 grow-0 shrink-0 background-color-white p-28-29-28-28 h-screen overflow-y-no-scrollbar"
    >
    ...
    <div class="p-0-28-28-28 basis-3/4 grow shrink overflow-hidden">
      <custom-header />
