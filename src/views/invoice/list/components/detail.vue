<template>
  <div class="flex flex-col">
    <div class="flex basis-50px p-0-30-0-29 items-center justify-between">
      <div
    ...
    <div class="flex <lg:flex-col">
          ...
          >
            <div class="flex gap-14 items-center">
              ...
              >
                <v-icon
                  icon="dropbox"
                  class="fill-primary width-18 height-18"
                />
              </div>
              <div
      ...
      >
        <div class="p-10-30-30-29">
          <div class="height-52 flex flex-start items-center">
            <div
              class="color-primary-dark font-size-18 font-700 line-height-27"
            >
